...
namespace NexusDogsGo.Domain
{
    ...
    public sealed class PlayerProfile
    {
        ...
        public List<DogInstance> Dogs = new List<DogInstance>();
    ...
    public sealed class InventoryState
    {
        ...
        public static InventoryState CreateStarter()
        {
            return new InventoryState
            {
                ...
                {
                    new InventoryEntry { ItemId = InventoryItemId.PokeBall, Quantity = 25 },
                    new InventoryEntry { ItemId = InventoryItemId.SuperBall, Quantity = 5 },
                    new InventoryEntry { ItemId = InventoryItemId.PremiumFood, Quantity = 3 },
                    new InventoryEntry { ItemId = InventoryItemId.HealPotion, Quantity = 10 },
                    new InventoryEntry { ItemId = InventoryItemId.Incense, Quantity = 2 },
                    new InventoryEntry { ItemId = InventoryItemId.Revive, Quantity = 1 }
                }
            };
        }
